...
- `Track list preset` (or `lineup preset`): A saved, named festival lineup configuration (cards and stacks) that the player can load before battle; used to keep multiple tuned setups for different battle types or metas.
